package CiF 
{
	...
	public class Util
	{
		...
		public static function createLocutionVectors(unparsedLine:String):Vector.<Locution> {
			...
			var examineRef:ExamineLocution;
			var discussRef:DiscussLocution;
			...
			for each(piece in parsedLine) {
				if (piece.toLowerCase() == "examineline")
				{
					examineRef = new ExamineLocution();
					locutions.push(examineRef);
				}
				else if (piece.toLowerCase() == "discusshate")
				{
					discussRef = new DiscussLocution();
					discussRef.type = "hate";
					locutions.push(discussRef);
				}
				else if (piece.toLowerCase() == "discussneutral")
				{
					discussRef = new DiscussLocution();
					discussRef.type = "neutral";
					locutions.push(discussRef);
				}
				else if (piece.toLowerCase() == "discusslike")
				{
					discussRef = new DiscussLocution();
					discussRef.type = "like";
					locutions.push(discussRef);
				}
				else if (piece.toLowerCase() == "discusslove")
				{
					discussRef = new DiscussLocution();
					discussRef.type = "love";
					locutions.push(discussRef);
				}
				else if (piece == "r") {
