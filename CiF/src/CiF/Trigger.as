package CiF 
{
	...
	public class Trigger extends Effect
	{
		...
		override public function evaluateCondition(initiator:GameObject, responder:GameObject = null, other:GameObject = null):Boolean 
		{
		 ...
		 */
		public function makeTriggerContext(time:Number, x:GameObject, y:GameObject = null, z:GameObject = null):TriggerContext {
